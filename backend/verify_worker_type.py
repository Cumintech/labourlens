...
signup = client.post(
    "/owners/signup",
    json={"name": "Type Owner A", "mobile": "9000000901", "password": "pass123", "factory_name": "Type Factory A"},
)
...
signup_b = client.post(
    "/owners/signup",
    json={"name": "Type Owner B", "mobile": "9000000902", "password": "pass123", "factory_name": "Type Factory B"},
)
