...
signup = client.post(
    "/owners/signup",
    json={"name": "Leave Owner A", "mobile": "9000000501", "password": "pass12345", "factory_name": "Leave Factory A", "consent_given": True},
)
...
signup_b = client.post(
    "/owners/signup",
    json={"name": "Leave Owner B", "mobile": "9000000502", "password": "pass12345", "factory_name": "Leave Factory B", "consent_given": True},
)
